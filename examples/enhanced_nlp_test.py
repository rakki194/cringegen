...
def test_natural_caption_generation():
    ...
    test_tag_sets = [
        ...
        ["best quality", "highly detailed", "wolf", "snowy mountains", "night scene", "blue eyes", "oil painting"],
        ["masterpiece", "anthropomorphic", "rabbit", "wearing blue dress", "garden", "flowers", "watercolor"],
        ["high quality", "detailed", "tiger", "orange fur", "black stripes", "jungle", "sunset", "realistic"],
        ["masterpiece", "fox girl", "red hair", "green eyes", "smiling", "beach", "summer", "anime style"]
    ]
...
def test_complex_prompts():
    ...
    complex_tag_sets = [
        [
            "masterpiece", "best quality", "detailed", "anthro", "female fox", 
            "red fur", "blue eyes", "wearing casual outfit", "smiling", 
            "sitting on bench", "city park", "sunset", "digital painting"
        ],
        [
            "best quality", "ultra detailed", "4k", "wolf", "male", "warrior", 
            "gray fur", "battle armor", "sword", "standing", "medieval castle", 
            "foggy", "dynamic pose", "fantasy", "dramatic lighting"
        ],
        [
            "masterpiece", "high quality", "detailed", "deer", "anthro", "female",
            "brown fur", "white spots", "green dress", "forest clearing", 
            "flowers", "spring", "soft lighting", "relaxed pose", "peaceful"
        ]
    ]
