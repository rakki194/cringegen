...
def demo_tag_classification():
    ...
    test_tags = [
        "fox", "cat girl", "warrior", "digital painting", 
        "anthro wolf", "feral tiger", "anime style", "pixel art",
        "masterpiece", "detailed", "forest", "school uniform"
    ]
...
def demo_tag_analysis():
    ...
    test_tag_sets = [
        ...
        # Anime set
        ["high quality", "anime style", "cat girl", "pink hair", "school uniform", "cherry blossoms"],
