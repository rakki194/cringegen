...
def test_tag_converter():
    ...
    test_tags = [
        "masterpiece", "best quality", "detailed", "fox girl", "anthro", 
        "red fur", "blue eyes", "wearing blue dress", "smiling", 
        "forest background", "digital art", "dynamic lighting"
    ]
    ...
    recovered = set(tag.lower() for tag in back_to_tags).intersection(set(tag.lower() for tag in original_tags))
...
def test_nltk_integration():
    ...
    entity_text = "John Smith visited New York City and met with representatives from Google and Apple."
    print(f"\nText: {entity_text}")
