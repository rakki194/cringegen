    ...
    "traditional": {
        ...
        "techniques": {
            ...
            "drawing": {
                ...
                "materials": [
                    "graphite", "charcoal", "ink", "colored pencil", "pastel",
                    "crayon", "marker", "chalk", "silverpoint"
                ],
            ...
            "printmaking": {
                ...
                "subtypes": [
                    "woodcut", "linocut", "engraving", "etching", "lithography",
                    "screen printing", "monotype", "collagraph"
                ],
            ...
            "sculpture": {
                ...
                "materials": [
                    "clay", "stone", "wood", "metal", "plaster", "glass",
                    "wire", "found objects", "mixed media"
                ],
                "techniques": [
                    "carving", "modeling", "casting", "assembling", "welding",
                    "mold-making", "construction"
                ]
            },
            "textile": {
                "name": "Textile Art",
                ...
                "techniques": [
                    "weaving", "embroidery", "quilting", "knitting", "crocheting",
                    "felting", "tapestry", "batik", "tie-dye"
                ],
    ...
    "digital": {
        ...
        "techniques": {
            "digital_painting": {
                ...
                "software": [
                    "Photoshop", "Procreate", "Krita", "Corel Painter",
                    "Clip Studio Paint", "GIMP", "Paint Tool SAI"
                ],
            ...
            "3d_art": {
                ...
                "software": [
                    "Blender", "Maya", "ZBrush", "Cinema 4D", "3ds Max", 
            ...
            "generative": {
                ...
                "subtypes": [
                    "algorithm-based", "AI-generated", "diffusion art", "GAN art", 
                    "procedural", "fractal art"
                ],
    ...
    "photography": {
        ...
        "genres": {
            "portrait": {
                ...
                "subtypes": ["headshot", "environmental", "fashion", "self-portrait", "group portrait"]
            },
            "landscape": {
            ...
            "abstract": {
                ...
                "techniques": ["macro", "intentional camera movement", "light painting", "defocusing"]
            },
            "commercial": {
        ...
        "techniques": [
            "digital", "film", "long exposure", "HDR", "black and white", 
            "infrared", "panoramic", "time-lapse", "light painting"
        ]
    },
    "mixed_media": {
        "name": "Mixed Media",
        ...
        "combinations": [
            "traditional + digital", "painting + collage", "photography + painting",
            "sculpture + digital", "drawing + painting", "printmaking + collage"
        ]
    }
}
...
STYLE_MOVEMENTS: Dict[str, Dict[str, Any]] = {
    ...
    "renaissance": {
        ...
        "characteristics": ["perspective", "anatomy", "realism", "classical themes", "religious themes"],
    ...
    "impressionism": {
        "name": "Impressionism",
        "period": "19th century",
        "characteristics": ["light effects", "visible brushstrokes", "outdoor scenes", "everyday life"],
    ...
    "abstract": {
        ...
        "subtypes": ["abstract expressionism", "geometric abstraction", "color field", "lyrical abstraction"]
    },
    "pop_art": {
        "name": "Pop Art",
        "period": "1950s-1970s",
        "characteristics": ["popular culture", "mass media", "bold colors", "irony", "everyday objects"],
    ...
    "contemporary": {
        ...
        "subtypes": [
            "installation", "performance", "new media", "digital art", 
            "conceptual art", "street art", "video art"
        ]
    }
}
...
STYLE_ANIMATION: Dict[str, Dict[str, Any]] = {
    ...
    "cartoon": {
        ...
        "subtypes": [
            "classic cartoon", "Saturday morning cartoon", "newspaper comic", 
            "political cartoon", "web comic"
        ]
    },
...
STYLE_AESTHETICS: Dict[str, Dict[str, Any]] = {
    ...
    "punk": {
        ...
        "subtypes": [
            "cyberpunk", "steampunk", "dieselpunk", "biopunk", "solarpunk", 
            "clockpunk", "gothpunk"
        ],
    ...
    "vaporwave": {
        ...
        "characteristics": [
            "80s/90s nostalgia", "glitch", "pastel colors", "classical sculpture", 
            "early digital graphics", "Japanese text"
        ]
    },
    "cottagecore": {
        "name": "Cottagecore",
