...
CHARACTER_TEMPLATE = CharacterTemplate(
    ...
    features=["feature1", "feature2", "feature3"],  # List of physical features
    clothing=["clothing1", "clothing2", "clothing3"],  # List of clothing items
    accessories=["accessory1", "accessory2"],  # List of accessories
    personality=["trait1", "trait2", "trait3"],  # List of personality traits
