...
MATERIAL_COLORS: Dict[str, List[str]] = {
    "metallic": ["chrome", "steel", "silver", "gold", "bronze", "copper", "brass", "titanium", "platinum"],
    "gemstone": ["ruby", "sapphire", "emerald", "amethyst", "diamond", "crystal", "quartz", "jade", "amber", "opal"],
    "fabric": ["velvet", "satin", "silky", "cotton", "woolen", "linen", "suede", "leather", "denim"],
    "natural": ["wooden", "stone", "earthy", "clay", "terracotta", "sandy", "pearlescent", "coral", "ivory"],
    "synthetic": ["neon", "glowing", "holographic", "iridescent", "reflective", "translucent", "glossy", "matte"],
}

# Color descriptors for enhanced descriptions
COLOR_DESCRIPTORS: Dict[str, List[str]] = {
    "intensity": ["pale", "light", "bright", "deep", "dark", "brilliant", "vivid", "muted", "dull", "saturated"],
    ...
    "pattern": ["gradiated", "ombré", "faded", "patchy", "striped", "spotted", "marbled", "swirled"],
    "transparency": ["transparent", "translucent", "opaque", "clear", "cloudy", "hazy", "crystalline"],
}
...
SPECIES_COLORS: Dict[str, List[str]] = {
    ...
    # Reptiles
    "dragon": ["red", "green", "blue", "black", "white", "gold", "silver", "bronze", "copper", "rainbow", "iridescent"],
...
COLOR_PALETTES: Dict[str, List[str]] = {
    "forest": ["green", "brown", "dark green", "moss green", "forest green", "earthy brown", "dark brown"],
    "desert": ["tan", "sand", "beige", "dusty orange", "burnt sienna", "yellow ochre", "terracotta"],
    "arctic": ["white", "light blue", "silver", "pale gray", "ice blue", "snow white", "crystal blue"],
    "tropical": ["vibrant green", "turquoise", "bright yellow", "coral", "lime green", "azure", "fuchsia"],
    "autumn": ["orange", "red", "brown", "golden yellow", "rust", "burgundy", "amber"],
    "cyberpunk": ["neon blue", "hot pink", "electric purple", "acid green", "neon yellow", "black", "chrome"],
    "fantasy": ["magical blue", "enchanted purple", "mystical green", "golden", "silver", "royal purple"],
} 