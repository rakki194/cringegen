...
def test_species_and_color():
    ...
    # Test species description - fix by using a string color rather than a list
    species_desc = generate_species_description("dragon", "blue")
    print(f"\nDescription for blue dragon: {species_desc}")
